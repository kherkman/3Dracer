// generate.js - Radan ja maaston generointimoottori (Korjattu tekstuuritoisto & 3D-rakenteet)
(function() {
  'use strict';
  ...
  function buildRoad(track, texturesEnabled, loadTextureWithFallback, ENV_TEXTURE_PATHS, currentEnvironment) {
    ...
    for (var i = 0; i < n; i++) {
      ...
      // Korjattu UV-skaalaus: tekstuurikuvio toistuu tasaisesti ratakappaleiden yli
      var v = s.dist / 12.0;
      uvs.push(0, v, 1, v);
    }
    ...
    // Tekstuurikertoimet korjattu muotoon (1, 1), jotta UV-ohjaus toimii puhtaasti
    var asphaltTex = texturesEnabled ? loadTextureWithFallback(asphaltTexUrl, 1, 1, '#333333', 'RATA') : makeAsphaltProceduralTex();
