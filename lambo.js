// lambo.js - Lambo-automallin 3D-määritelmä (Viistoitettu terävä kiilakeula)
(function() {
  ...
  window.CAR_MODELS['lambo'] = function(bodyColorHex, accentColorHex, carTexUrl) {
    ...
    // --- Lambo: Terävä mutta kulmista viistoitettu kiilakeula ---
    var noseGeo = new THREE.BoxGeometry(1.52, 0.22, 1.2);
    ...
    for (var i = 0; i < pos.count; i++) {
      ...
      if (z > 0) { // Etuosa
        ...
        pos.setX(i, pos.getX(i) * (1.0 - factor * 0.36)); // Sulava kulmikas viistoitus
      }
    }
    noseGeo.computeVertexNormals();
    noseGeo.translate(0, 0.33, 1.55);
    ...
    var hl1 = new THREE.Mesh(new THREE.BoxGeometry(0.28, 0.05, 0.12), headLightMat);
    hl1.rotation.y = -0.22;
    hl1.position.set(-0.46, 0.38, 1.68);
    var hl2 = hl1.clone();
    hl2.rotation.y = 0.22;
    hl2.position.x = 0.46;
    ...
    spot1.position.set(-0.46, 0.38, 1.70);
    spot1.target.position.set(-0.46, 0.1, 15);
    ...
    spot2.position.set(0.46, 0.38, 1.70);
    spot2.target.position.set(0.46, 0.1, 15);
