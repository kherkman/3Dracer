// env_hitech.js - Hi-Tech futuristisen kaupunkiympäristön 3D-määritelmä (Valaistut rakennukset)
(function() {
  ...
  window.ENV_BUILDERS['hitech'] = function(track, bounds, ctx) {
    ...
    while (placedCount < numBuildings && attempts < maxAttempts) {
      ...
      // Säädetty roughness ja metalness paremman näkyvyyden saavuttamiseksi
