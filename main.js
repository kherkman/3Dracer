...
(function() {
  ...
  var minimapEnabled = false;          // Ratakuva On/Off (default Off)
  var rearviewMirrorEnabled = false;   // Taustapeili On/Off (default Off)
  ...
  function renderRearviewMirror() {
    ...
    // Sijoitetaan peilikamera auton yläpuolelle katsomaan taaksepäin
  ...
  function generateCustomDrawnTrack() {
    ...
    if (typeof TrackGenerator.buildPitStop === 'function') {
      var pData = TrackGenerator.buildPitStop(currentTrack, tireWearEnabled || damageEnabled);
      ...
      if (c) {
        ...
        if (c.finished) {
          ...
          if (speedometerEnabled) {
            ...
            html += '<div class="analog-speedometer-box">';
  ...
  function regenerateAll(){
    ...
    if (typeof TrackGenerator.buildPitStop === 'function') {
      var pData = TrackGenerator.buildPitStop(track, tireWearEnabled || damageEnabled);
      pitStopGroup = pData.group;
