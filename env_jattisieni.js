...
(function() {
  ...
  window.ENV_BUILDERS['jattisieni'] = function(track, bounds, ctx) {
    ...
    // Ladataan sieni.jpg tekstuuri lakkimateriaalille
    var shroomTex = null;
    if (ctx.texturesEnabled && typeof ctx.loadTextureWithFallback === 'function') {
      shroomTex = ctx.loadTextureWithFallback('sieni.jpg', 1, 1, '#ffffff', 'SIENI');
    }
    ...
    for (var i = 0; i < numMushrooms; i++) {
      ...
      // Lakki (Pyöreä tattimainen hohtava sieni tekstuurilla ja värillä)
