// env_kaupunki.js - Kaupunkiympäristön 3D-määritelmä (Heijastavat siniset ikkunat)
(function() {
  ...
  window.ENV_BUILDERS['kaupunki'] = function(track, bounds, ctx) {
    ...
    while (placedCount < numBuildings && attempts < maxAttempts) {
      ...
      var glassMat = new THREE.MeshStandardMaterial({
        color: 0x38bdf8,            // Raikas sininen
        map: windowTexInst,
        roughness: 0.05,             // Peilimäinen siledys
        metalness: 0.85,             // Metallinen heijastavuus
        transparent: true,
        opacity: 0.92,
        emissive: 0x0284c7,          // Hieno sininen hohde
