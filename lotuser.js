// lotuser.js - Lotuser-automallin 3D-määritelmä
(function() {
  ...
  window.CAR_MODELS['lotuser'] = function(bodyColorHex, accentColorHex, carTexUrl) {
    ...
    // --- Korin muotoilu (Kevyt ja matala roadster) ---
    // Pääkoripaneeli
    ...
    // Pyöristetty, matala ohjaamo / tuulilasi
    ...
    // Tupla-etualueen pyöreät ajovalot
    ...
    hl1.position.set(-0.48, 0.46, 1.62);
    ...
    spot1.position.set(-0.48, 0.46, 1.65);
    ...
    spot2.position.set(0.48, 0.46, 1.65);
